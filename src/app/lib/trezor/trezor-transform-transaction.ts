...
/* tslint:disable */
// @ts-nocheck
// TODO: Convert this into a fully TS module

import * as StellarSdk from 'stellar-sdk';
import BigNumber from 'bignumber.js';
import { StellarSignTransaction } from 'trezor-connect';
/**
 ...
 */
export const trezorTransformTransaction = (path, transaction): StellarSignTransaction => {
  const amounts = [
    "amount",
    "sendMax",
    "destAmount",
