...
import {
  ...
  HorizonApisQuery,
  ILpAsset,
  ILpAssetLoaded, IWalletAsset, IWalletsAccount,
  LpAssetsQuery,
...
@Component({
  selector: 'app-liquidity-pools-overview',
  templateUrl: './liquidity-pools-overview.component.html',
  styleUrls: ['./liquidity-pools-overview.component.scss']
})
export class LiquidityPoolsOverviewComponent implements OnInit, OnDestroy {
